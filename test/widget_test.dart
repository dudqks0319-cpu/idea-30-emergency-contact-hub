...
import 'package:app_30_emergency_contact_hub/app.dart';
import 'package:app_30_emergency_contact_hub/services/supabase_service.dart';
...
void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('비상연락망 병원 허브'), findsWidgets);
